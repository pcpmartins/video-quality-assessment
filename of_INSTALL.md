[openFrameworks](http://openframeworks.cc/) | [Documentation table of contents](https://github.com/openframeworks/openFrameworks/blob/master/docs/table_of_contents.md)
