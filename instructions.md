...
* It can also be used to rotate videos arbitrarily:

As an example stripRotate 2 will transpose every file in data/files folder  90 degree CounterClockwise to data/fixed folder using:
